...
public class InventoryEditor extends AppCompatActivity implements
    ...
    /**
     * Identifier for the inventory image data loader
     */
    public static final int PICK_PHOTO_REQUEST = 20;

    /**
     * Identifier for the user access to iamges
     */
    ...
    private Button actIncrement;
    private Button actDecrement;

    private String mCurrentPhotoUri = "no images";
    private String mEmail;
    private String mEmailProduct;
    private int mEmailQuantity = 50;
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        actDecrement = (Button) findViewById(R.id.btn_decrease_inventory);
        actIncrement = (Button) findViewById(R.id.btn_increase_inventory);
        ...
        actDecrement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                decrement();
            }
        ...
        actIncrement.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                increment();
            }
    ...
    /**
     * Get user input from editor and save/update inventory into database.
     */
    ...
    /**
     * This method resets all text fields
     */
    @Override
    ...
    /**
     * Perform the order of the fro nes inventory.
     */
    private void orderSupplier() {
        ...
        emailIntent.putExtra(Intent.EXTRA_SUBJECT, "Order " + mEmailProduct);
        emailIntent.putExtra(Intent.EXTRA_TEXT, "Please ship " + mEmailProduct +
                " in quantities " + mEmailQuantity);
